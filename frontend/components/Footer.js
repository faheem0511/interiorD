        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/design-styles" className="text-gray-300 hover:text-white">Design Styles</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/kitchen" className="text-gray-300 hover:text-white">Kitchen Design</Link></li>
              <li><Link href="/home-office" className="text-gray-300 hover:text-white">Home Office Design</Link></li>
              <li><Link href="/full-home" className="text-gray-300 hover:text-white">Full Home Design</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/refund" className="text-gray-400 hover:text-white text-sm">Refund Policy</Link>
            </div>
          </div>
        </div>
      </div>
