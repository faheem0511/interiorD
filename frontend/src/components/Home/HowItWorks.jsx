export default function HowItWorks() {
  return (
    <section className="relative w-full bg-[#F7F2EC] py-20 px-6 md:px-16 overflow-hidden items-center">
      <h2 className="text-3xl md:text-5xl font-semibold text-center mb-12 font-serif text-gray-800">
        Experience Online Room Design
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-start max-w-6xl mx-auto">
        {/* Left Image */}
        <div className="relative flex flex-col items-center">
          ...
          />
          {/* Bottom description */}
          <div className="mt-8 md:mt-20 text-center max-w-3xl mx-auto text-gray-700 text-lg md:text-xl leading-relaxed">
        ...
        <div className="hidden md:block absolute bottom-35 left-[51%] -translate-x-1/2">
          <img
            src="/Arrow.jpg"
            alt="Arrow"
