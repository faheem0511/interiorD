...
import Navbar from "../Navbar";
 ...
 <section className="hero-section relative h-screen bg-center bg-cover overflow-hidden" style={{ backgroundImage: "url('/h3.jpg')" }}>
      {/* Darker overlay especially at the top */}
      ...
      <div className="absolute inset-0">
        {/* Left window light */}
        <div className="absolute top-0 left-[15%] w-[20%] h-[40%] bg-gradient-to-b from-white/30 via-white/15 to-transparent blur-sm"></div>
        
        {/* Center window light */}
        <div className="absolute top-0 left-[40%] w-[20%] h-[40%] bg-gradient-to-b from-white/30 via-white/15 to-transparent blur-sm"></div>
        
        {/* Right window light */}
        <div className="absolute top-0 right-[25%] w-[15%] h-[45%] bg-gradient-to-b from-white/30 via-white/15 to-transparent blur-sm"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        {/* <button className="bg-[#846A4D] text-white px-6 py-3 rounded-2xl shadow-lg hover:bg-[#6d5840] transition duration-300">
          Start Your Project
        </button> */}
      </div>
    </section>
