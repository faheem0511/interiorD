    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-decorilla-blue/10">
            ...
            <div className="h-48 lg:h-auto lg:flex-1 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/20 to-black/20"></div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
                <div className="w-full max-w-md">
                    <div className="bg-white lg:bg-decorilla-blue/10 p-6 sm:p-8 rounded-xl shadow-md lg:border-black">
