...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F7F2EC] text-black pt-12 md:pt-16 pb-8 px-4 md:px-8 lg:px-15 xl:px-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 lg:gap-1 mb-12">
          {/* Company Info */}
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row">
              <input
                ...
                className="px-4 py-2 w-full rounded-md sm:rounded-l-md sm:rounded-r-none text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#A78A68] mb-2 sm:mb-0"
                required
              />
              <button
                type="submit"
                onClick={handleSubscribe}
                className="bg-[#A78A68] hover:bg-[#846A4D] px-4 py-2 rounded-md sm:rounded-l-none sm:rounded-r-md transition-colors text-white font-medium"
              >
                Subscribe
              </button>
            </div>
